module.exports = {
    "en": {
        ...
        "shiftDigitDisplay.description": "Digital display based on 74HC595 with dynamic scanning display.",
        "u8g2.description": "U8g2 is a general graphics library for multiple screens, which is suitable for LCD (based on ST7920) or OLED (based on SSD1306) screens.",
        "cooperativeScheduler.name": "Cooperative Scheduler",
        "cooperativeScheduler.description": "Allow Arduino to run multiple tasks.",
        ...
        "arduinoOttoRobot.description": "An open-source modular robot with an epic personality."
    }
};
